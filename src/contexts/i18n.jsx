...
const translations = {
  en: {
    ...
    experience: {
      ...
      bullet1: 'Developed a scalable, high-performance design system to unify technical efforts across web and mobile products, accelerating delivery time',
      bullet2: 'Optimized global content delivery by implementing CDN strategies and server-side configurations, ensuring low-latency experiences for a worldwide user base',
      bullet3: 'Pioneered the integration of LLMs and Prompt Engineering into the development cycle to automate test suites and optimize internal workflows, increasing team velocity',
      bullet4: 'Lead a global multidisciplinary team under Agile methodologies, driving code quality through rigorous technical reviews and professional mentoring',
    },
    projects: {
  ...
  es: {
    ...
    experience: {
      ...
      bullet1: 'Desarrollé un sistema de diseño escalable y de alto rendimiento para unificar los esfuerzos técnicos en productos web y móviles, acelerando el tiempo de entrega',
      bullet2: 'Optimicé la entrega de contenido global implementando estrategias CDN y configuraciones server-side, garantizando experiencias de baja latencia para usuarios mundiales',
      bullet3: 'Pionero en la integración de LLMs y Prompt Engineering en el ciclo de desarrollo para automatizar suites de pruebas y optimizar flujos de trabajo internos',
      bullet4: 'Dirijo un equipo global multidisciplinario bajo metodologías Agile, impulsando la calidad del código mediante revisiones técnicas rigurosas y mentoring profesional',
    },
    projects: {
