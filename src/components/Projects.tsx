    ...
    <section id="projects" className="mb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {projectsData.map((project, index) => (
          <div
            key={index}
            className={`rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:scale-105 cursor-pointer ${
                ...
                {project.technologies.map((tech, techIndex) => (
                  <span
                    ...
                    className={`px-3 py-2 rounded-full text-sm ${
                      darkMode ? "bg-blue-700 text-white" : "bg-blue-300 text-blue-800"
                    }`}
                  >
                    {tech}
                  </span>
                ...
                <div className="flex space-x-4">
                  <a
                    ...
                    className={`flex items-center ${
                      darkMode ? "text-blue-400 hover:text-blue-300" : "text-blue-800 hover:text-blue-600"
                    }`}
                  >
                  ...
                  {project.live && (
                    <a
                      ...
                      rel="noopener noreferrer"
                      className={`flex items-center ${
                        darkMode ? "text-green-400 hover:text-green-300" : "text-green-800 hover:text-green-600"
                      }`}
                    >
      ...
      {selectedProject !== null && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div
            className={`rounded-lg max-w-6xl w-full p-12 relative ${
              darkMode ? "bg-gray-800" : "bg-gray-200"
            }`}
          >
            <button
